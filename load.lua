...
Player = {
	...
	x = 900,
	y = 500
	-- Backpack is the naming of the dpad item selector, which allows a max of four items at a time
	,
...
Keybinds = {
	controller = {
		backpack = { "dpup", "dpright", "dpdown", "dpleft" }
		,
		dash = "leftshoulder"
		,
		pickupMode = "a"
...
function love.load()
	DTotal = 0
	love.window.setMode(1920, 1066,
		{ fullscreen = true, resizable = false, vsync = false, centered = true, minwidth = 400, minheight = 300 })
	...
	Audio = {
		hitmark = love.audio.newSource("assets/audio/hitmarker.mp3", "static"),
